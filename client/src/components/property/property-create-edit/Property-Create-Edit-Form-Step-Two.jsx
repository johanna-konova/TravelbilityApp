                    ...
                    <Row className={styles["facilities"]} >
                        <Col lg={6}>
                            ...
                            {commonFacilities.map(cf => (
                                <label key={cf._id} className={styles["custom-checkbox"]}>
                                    <input
                                        type="checkbox"
                                        value={cf._id}
                                        checked={watch("step-2.commonFacilityIds")?.includes(cf._id)}
                        ...
                        <Col lg={6}>
                            ...
                            {accessibility.map(a => (
                                <label key={a._id} className={styles["custom-checkbox"]}>
                                    <input
                                        type="checkbox"
                                        value={a._id}
                                        checked={watch("step-2.accessibilityIds")?.includes(a._id)}
